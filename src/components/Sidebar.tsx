...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo + Brand */}
      <div
        className={`flex items-center border-b border-nav transition-all duration-300 ${
          collapsed
      ...
      >
        ...
        {!collapsed && (
          <div className="flex flex-col min-w-0">
            ...
            <span className="text-nav text-[9px] tracking-widest uppercase whitespace-nowrap">
                        ...
                        className={`
                          ...
                          ${
                            isActive
                              ...
                              : 'text-nav hover:bg-white/5 hover:text-nav-active'
                          }
                          ${
                            collapsed
                              ? 'justify-center'
                        ...
                        {collapsed && (
                          <span
                            className="
                              ...
                              bg-foreground text-white text-[12px]
                              font-medium rounded-md whitespace-nowrap
                              opacity-0 group-hover:opacity-100
                              pointer-events-none transition-opacity
                              duration-150 z-50 shadow-lg
                            "
                          >
                            {item.label}
                          </span>
        ...
        {[
          ...
          ({
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-nav hover:bg-white/5 hover:text-nav-active transition-all duration-150 group relative ${
                collapsed
                  ? 'justify-center'
                  : ''
              }`}
        ...
        >
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-nav truncate">
                Survey Operator
              </p>
            </div>
          )}
          ...
          {!collapsed && (
            <button
              suppressHydrationWarning
              className="text-nav hover:text-nav-active transition-colors duration-150 ml-auto"
            >
              <LogOut size={15} />
            </button>
          )}
